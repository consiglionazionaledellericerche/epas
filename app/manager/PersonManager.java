...
//			Solo un omonimo
			if(sequence.isEmpty()){
				user.username = standardUsername+1;
			}
//			Più di un omonimo
			else{
				user.username = standardUsername+(Collections.max(sequence)+1);
			}
		}
