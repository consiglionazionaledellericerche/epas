...
public class PersonDayManager {
  ...
  /**
   *
   * @param personDay il giorno interessato
   * @return il tempo in minuti relativo ai permessi brevi di quel giorno.
   */
  ...
  public PersonDay updateTimeAtWork(PersonDay personDay, WorkingTimeTypeDay wttd,
    ...
    for (Absence abs : personDay.getAbsences()) {
      ...
      if (abs.justifiedType != null) {
        ...
        //Questo e' il caso del codice 105BP che garantisce sia l'orario di lavoro che
        // il buono pasto
        ...
        if (abs.justifiedType.name.equals(JustifiedTypeName.specified_minutes)) {
          personDay
              .setJustifiedTimeNoMeal(personDay.getJustifiedTimeNoMeal() + abs.justifiedMinutes);
          continue;
        }
  ...
  /**
   *
   * @param person la Persona interessata
   * @param from   la data iniziale dell'intervallo
   * @param to     la data finale dell'intervallo
   * @return I giorni festivi della persona nella finestra specificata.
   */
