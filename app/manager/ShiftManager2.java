...
public class ShiftManager2 {
   ...
   * @param to data fine
   * @return se tutti i turni relativi ai parametri passatii sono validi.
   */
  public boolean allValidShifts(ShiftType activity, Person person, 
      LocalDate from, LocalDate to) {
