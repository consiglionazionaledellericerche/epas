...
public class ShiftManager {
	 ...
	 */
	public static List<ShiftPeriod> getPersonShiftPeriods (List<PersonShiftDay> personShiftDays) {
	 ...
	 * @return la lista dei periodi di turno lavorati 
	 */
	public static List<ShiftPeriod> getDeletedShiftPeriods (List<ShiftCancelled> personShiftCancelled) {
	 ...
	 * @return 			-	
	 */
	public static void savePersonShiftDaysFromShiftPeriods(ShiftType shiftType, Integer year, Integer month, ShiftPeriods shiftPeriods) {
...
//				.executeUpdate();
	 ...
	 */
	public static List<AbsenceShiftPeriod> getAbsentShiftPeriodsFromAbsentShiftDays(List<Absence> absencePersonShiftDays, ShiftType shiftType) {
	 ...
	 */
	public static int[] calcShiftValueApproved(Person person, int year, int month, int requestedMins) {
		int hoursApproved = 0;
		int exceedMins = 0;
		int oldExceedMins = 0;
...
//					person, year, month, competenceCode).first();
	 ...
	 */
	public static Table<Person, String, String> getPersonsReportShiftInfo (Table<Person, String, Integer> totalPersonShiftWorkedTime, List<Competence> competenceList) {
	 ...
	 */
	public static Table<Person, String, Integer> calcShiftWorkedDaysAndLackTime(Table<Person, String, Integer> personsShiftsWorkedDays, Table<Person, String, List<String>> totalInconsistentAbsences) {
	 ...
	 */
	public static void buildMonthlyShiftCalendar(LocalDate firstOfMonth, ShiftType shiftType, Table<String, Integer, SD> shiftCalendar) {
