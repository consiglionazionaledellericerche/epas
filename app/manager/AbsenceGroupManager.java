...
public class AbsenceGroupManager {
   ...
   * d'assenza ha un gruppo che non prevede l'accumulo di valori: in effetti bisognerebbe capire se
   * abbia senso una cosa del genere visto che allora non esistono casi che possano verificare la
   * situazione opposta
   */
   ...
   * controllato di non aver ecceduto in quantità nel periodo di tempo previsto dal tipo di accumulo
   * e, nel caso, lo sostituisce con il codice di rimpiazzamento se arriva al limite previsto per
   * quel codice
   */
