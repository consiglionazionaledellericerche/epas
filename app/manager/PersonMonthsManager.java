...
public class PersonMonthsManager {
	 ...
	 * @param to
	 */
	public static void saveTrainingHours(PersonMonthRecap pm, boolean approved, Integer value, LocalDate from, LocalDate to){
	 ...
	 * dei problemi
	 */
	public static Insertable checkIfInsertable(int begin, int end, Integer value, LocalDate beginDate, LocalDate endDate){
	 ...
	 */
	public static Insertable checkIfPeriodAlreadyExists(Person person, int year, int month, LocalDate beginDate, LocalDate endDate){
	 ...
	 */
	public static Insertable checkIfAlreadySend(Person person, int year, int month){
		Insertable rr = new Insertable(true, "");
	 ...
	 */
	public static Insertable checkIfExist(PersonMonthRecap pm){
		Insertable rr = new Insertable(true, "");
