...
public class Clocks extends Controller{
	...
	public static void clockLogin(Long userId, String password)
	{
		...
		PersonDay pd = PersonDayDao.getSinglePersonDay(user.person, today).get();
	...
	public static void insertStamping(Long personId){
		...
		PersonDay pd = PersonDayDao.getSinglePersonDay(person, ldt.toLocalDate()).get();
	...
	public static void showRecap(Long personId)
	{
		...
		LocalDate today = new LocalDate();
		PersonDay pd = PersonDayDao.getSinglePersonDay(person, today).get();
