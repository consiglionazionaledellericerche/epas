...
public class AbsenceGroups extends Controller {
  ...
  public static void prepare24() {
    ...
    code24.description = "Astensione facoltativa post partum non retrib. primo figlio intera giornata";
    code24.certificateCode = "24";
    code24.internalUse = false;
    code24.justifiedTypesPermitted.clear();
    code24.justifiedTypesPermitted.add(absenceComponentDao.getOrBuildJustifiedType(JustifiedTypeName.all_day));
    ...
    code24M.description = "Astensione facoltativa post partum non retrib. primo figlio in ore e minuti";
    code24M.certificateCode = "24M";
    code24M.internalUse = true;
    code24M.justifiedTypesPermitted.clear();
    code24M.justifiedTypesPermitted.add(absenceComponentDao.getOrBuildJustifiedType(JustifiedTypeName.specified_minutes));
    ...
    code24U.description = "Astensione facoltativa post partum non retrib. primo figlio intera giornata altro genitore";
    code24U.certificateCode = "24U";
    code24U.internalUse = true;
    code24U.justifiedTypesPermitted.clear();
    code24U.justifiedTypesPermitted.add(absenceComponentDao.getOrBuildJustifiedType(JustifiedTypeName.all_day_limit));
    ...
    code24H7.description = "Astensione facoltativa post partum non retrib. primo figlio completamento giornata";
    code24H7.certificateCode = "24H7";
    code24H7.internalUse = false;
    code24H7.justifiedTypesPermitted.clear();
    code24H7.justifiedTypesPermitted.add(absenceComponentDao.getOrBuildJustifiedType(JustifiedTypeName.nothing));
    ...
    group24.description = "24 - Astensione facoltativa post partum non retrib. primo figlio 0-12 anni 600 giorni";
    ...
    GroupAbsenceType group25 = absenceComponentDao.groupAbsenceTypeByName(GroupEnum.G_25.name()).get();
    group25.nextGroupToCheck = group24;
    group25.save();
	  
    //definire le etichette dei gruppi e della catena
    
    //definire l'inizializzabilità dei gruppi
