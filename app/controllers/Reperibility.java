...
public class Reperibility extends Controller {
  ...
  /**
   * @author cristian, arianna Fornisce i periodi di reperibilità del personale reperibile di tipo
  ...
  /**
   * @author arianna Fornisce la lista del personale reperibile di tipo 'type' nell'intervallo di
  ...
  /**
   * @author arianna Legge le assenze dei reperibili di una determinata tipologia in un dato
  ...
  /**
   * @author arianna Restituisce la lista delle persone reperibili assenti di una determinata
  ...
  /**
   * @author cristian, arianna Aggiorna le informazioni relative alla Reperibilità del personale
   *
  ...
  /**
   * @author arianna Scambia due periodi di reperibilità di due persone reperibili diverse
   *
   * Per provarlo è possibile effettuare una chiamata JSON come questa: $  curl -H "Content-Type:
  ...
  /**
   * @author arianna, cristian crea il file PDF con il calendario annuale delle reperibilità di tipi
  ...
  /**
   * @author arianna restituisce una tabella con le eventuali inconsistenze tra le timbrature dei
