...
public class GroupAbsenceType extends BaseModel {
  ...
  public enum DefaultGroup {
    ...
    G_89("89 - Permesso diritto allo studio 150 ore anno", 
        "", 
        DefaultCategoryType.DIRITTO_STUDIO, 0,
        GroupAbsenceTypePattern.programmed, PeriodType.year, 
    ...
    FERIE_CNR_PROROGA("Ferie dopo 31/08", 
        "", 
    ...
    G_24("24 - Astensione facoltativa post partum non retrib. primo figlio 0-12 anni 600 giorni", 
        "", 
        DefaultCategoryType.CONGEDI_PARENTALI, 0,
    ...
    G_25P("25P - Prolungamento astensione facoltativa post partum 30% (no limiti)",
        "", 
        DefaultCategoryType.CONGEDI_PARENTALI_PROVVISORI, 0,                //se fosse primo figlio:
    ...
    EMPLOYEE("Codici inseribili dai dipendenti", 
        "", 
        DefaultCategoryType.CODICI_DIPENDENTI, 0,
        GroupAbsenceTypePattern.simpleGrouping, PeriodType.always, 
    ...
    G_ALTRI_CODICI("Tutti gli altri codici", 
        "", 
        DefaultCategoryType.TUTTI_I_CODICI, 0,
        GroupAbsenceTypePattern.simpleGrouping, PeriodType.always, 
        DefaultTakable.T_ALTRI, null, null, false, false),
    
    G_PERMESSI_SINDACALI("7 - Permesso sindacale ore", 
        "", 
        DefaultCategoryType.PERMESSI_SINDACALI, 0,
        GroupAbsenceTypePattern.simpleGrouping, PeriodType.always, 
    ...
    G_ASSEMBLEA("0 - Assemblea", 
        "", 
        DefaultCategoryType.ALTRI_GRUPPI, 0,
        GroupAbsenceTypePattern.simpleGrouping, PeriodType.always, 
