...
public enum DefaultTakable {
  ...
  T_21P(AmountType.units,
      ...
      ImmutableSet.of(DefaultAbsenceType.A_21P), 
      10, null),
  T_212P(AmountType.units,
      ImmutableSet.of(DefaultAbsenceType.A_212P), 
      ImmutableSet.of(DefaultAbsenceType.A_212P), 
      10, null),
  T_213P(AmountType.units,
      ImmutableSet.of(DefaultAbsenceType.A_213P), 
      ImmutableSet.of(DefaultAbsenceType.A_213P), 
      10, null),
  ...
  T_LAGILE(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_LAGILEBP, DefaultAbsenceType.A_LAGILE), 
      ImmutableSet.of(DefaultAbsenceType.A_LAGILEBP, DefaultAbsenceType.A_LAGILE), 
      10, null),

  T_39LA(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_39LABP, DefaultAbsenceType.A_39LA), 
      ImmutableSet.of(DefaultAbsenceType.A_39LABP, DefaultAbsenceType.A_39LA), 
      -1, null),
...
//      -1, null),
  ...
  T_FERIE_CNR_PROROGA_2024(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_31_2024), 
      ImmutableSet.of(DefaultAbsenceType.A_31_2024), 
      -1, null),
  ...
  T_243PROV(AmountType.units, 
      ...
      ImmutableSet.of(DefaultAbsenceType.A_243PROV, DefaultAbsenceType.A_243MPROV), 
      60, null),
  T_244PROV(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_244PROV, DefaultAbsenceType.A_244MPROV), 
      ImmutableSet.of(DefaultAbsenceType.A_244PROV, DefaultAbsenceType.A_244MPROV), 
      60, null),
  T_245PROV(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_245PROV, DefaultAbsenceType.A_245MPROV), 
      ImmutableSet.of(DefaultAbsenceType.A_245PROV, DefaultAbsenceType.A_245MPROV), 
      60, null),
  ...
  T_235(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_235, 
          DefaultAbsenceType.A_235M, 
          DefaultAbsenceType.A_235U), 
      ImmutableSet.of(DefaultAbsenceType.A_235, 
          DefaultAbsenceType.A_235M, 
          DefaultAbsenceType.A_235U), 30, null),
  ...
  T_255(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_255, 
          DefaultAbsenceType.A_255M), 
      ImmutableSet.of(DefaultAbsenceType.A_255, 
          DefaultAbsenceType.A_255M), 
      90, null),
  ...
  T_255A(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_255A, 
          DefaultAbsenceType.A_255AM), 
      ImmutableSet.of(DefaultAbsenceType.A_255A, 
          DefaultAbsenceType.A_255AM), 
      90, null),
  ...
  T_ALTRI(AmountType.units, 
      ImmutableSet.of(
          ...
          DefaultAbsenceType.A_99, 
          DefaultAbsenceType.A_16, DefaultAbsenceType.A_42, DefaultAbsenceType.A_50,
          ...
          DefaultAbsenceType.A_406, DefaultAbsenceType.A_405,DefaultAbsenceType.A_416,
          DefaultAbsenceType.A_62S40V, DefaultAbsenceType.A_98CV, 
  ...
  T_ASPETTATIVA(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_54, DefaultAbsenceType.A_54C, DefaultAbsenceType.A_54D,
          ...
          DefaultAbsenceType.A_54VVH7, DefaultAbsenceType.A_54TD),
      ImmutableSet.of(DefaultAbsenceType.A_54, DefaultAbsenceType.A_54C, DefaultAbsenceType.A_54D,
          DefaultAbsenceType.A_54DD,
          DefaultAbsenceType.A_54E, DefaultAbsenceType.A_54F, DefaultAbsenceType.A_54P,
          DefaultAbsenceType.A_54A17, DefaultAbsenceType.A_54CNR, DefaultAbsenceType.A_54ORGPP,
  ...
  T_RIDUCE_FERIE_CNR(AmountType.units, 
      ImmutableSet.of(
          ...
          DefaultAbsenceType.A_62S75V, DefaultAbsenceType.A_62, 
