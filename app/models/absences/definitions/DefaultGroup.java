...
public enum DefaultGroup {
  ...
  G_18("18 - Permesso assistenza parenti/affini disabili L. 104/92 tre giorni mese", "",
      ...
      DefaultTakable.T_18, DefaultComplation.C_18, null, false, false), G_18_PARENTI_DIPENDENTI(
          "18 - Permesso assistenza parenti/affini disabili L. 104/92 tre giorni mese", "",
          DefaultCategoryType.L_104_PARENTI_DIPENDENTI, 2, GroupAbsenceTypePattern.programmed,
          PeriodType.month, DefaultTakable.T_18, DefaultComplation.C_18, null, false, false), G_18P(
              "18P - Permesso provv. assistenza parenti/affini disabili L. 104/92 tre giorni mese",
              "", DefaultCategoryType.PERMESSI_PROVVISORI_104, 0,
              GroupAbsenceTypePattern.programmed, PeriodType.month, DefaultTakable.T_18P,
              DefaultComplation.C_18P, null, false, false),
  ...
  G_182("182 - Permesso assistenza secondo parenti/affini disabili L. 104/92 tre gg. mese", "",
      ...
      DefaultTakable.T_182, DefaultComplation.C_182, null, false, false), G_182P(
          "182P - Permesso provv. assist. secondo parenti/affini dis. L. 104/92 tre gg. mese", "",
  ...
  G_19("19 - Permesso per dipendente disabile L. 104/92 tre giorni mese", "",
      ...
      DefaultTakable.T_19, DefaultComplation.C_19, null, false,
      false), G_19_DIPENDENTI("19 - Permesso per dipendente disabile L. 104/92 tre giorni mese", "",
          DefaultCategoryType.L_104_DIPENDENTI, 2, GroupAbsenceTypePattern.programmed,
          PeriodType.month, DefaultTakable.T_19, DefaultComplation.C_19, null, false, false), G_19P(
              "19P - Permesso provv. per dipendente disabile L. 104/92 tre giorni mese", "",
              DefaultCategoryType.PERMESSI_PROVVISORI_104, 0, GroupAbsenceTypePattern.programmed,
  ...
  G_26("26 - Permesso per dipendente disabile L. 104/92 due ore giornaliere", "",
      ...
      DefaultTakable.T_26, null, null, false,
      false), G_26_DIPENDENTI("26 - Permesso per dipendente disabile L. 104/92 due ore giornaliere",
  ...
  G_631("631 - Permesso per visita medica", "", DefaultCategoryType.VISITA_MEDICA, 1,
      ...
      DefaultComplation.C_631, null, false, true), MISSIONE_GIORNALIERA("Missione giornaliera", "",
          DefaultCategoryType.MISSIONE_CNR, 0, GroupAbsenceTypePattern.programmed, PeriodType.year,
          DefaultTakable.T_MISSIONE_INTERNA, null, null, false,
          false), MISSIONE_COMUNE_RESIDENZA("Missione nel comune di residenza", "",
              DefaultCategoryType.MISSIONE_CNR, 2, GroupAbsenceTypePattern.simpleGrouping,
              PeriodType.year, DefaultTakable.T_MISSIONE_COMUNE_RESIDENZA, null, null, false,
              false), MISSIONE_ORARIA("Missione oraria", "", DefaultCategoryType.MISSIONE_CNR, 1,
                  GroupAbsenceTypePattern.programmed, PeriodType.year, DefaultTakable.T_MISSIONE,
                  DefaultComplation.C_92, null, false, false), MISSIONE_ESTERA("Missione estera",
  ...
  FERIE_CNR("31/94/32 - Ferie e permessi legge", "", DefaultCategoryType.FERIE_CNR, 0,
      ...
      null, false, false), FERIE_CNR_DIPENDENTI("Ferie e permessi legge", "",
          DefaultCategoryType.FERIE_DIPENDENTI, 2, // must be greater than FERIE_CNR
          GroupAbsenceTypePattern.vacationsCnr, PeriodType.always, DefaultTakable.T_FERIE_CNR, null,
          null, false, false), FERIE_CNR_PROROGA("37 - Ferie dopo 31/08", "",
  ...
  G_24("24 - Astensione facoltativa post partum non retrib. primo figlio 0-12 anni 600 giorni", "",
      ...
      true), G_25("25 - Astensione facoltativa post partum 30% primo figlio 0-6 anni 150 giorni",
          "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
  ...
  G_242(
      "242 - Astensione facoltativa post partum non retrib. "
  ...
  G_243("243 - Astensione facoltativa post partum non retrib. terzo figlio 0-12 anni 600 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child3_0_12, DefaultTakable.T_243, DefaultComplation.C_243, null, false,
      true), G_253("253 - Astensione facoltativa post partum 30% terzo figlio 0-6 anni 150 giorni",
          "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
  ...
  G_244("244 - Astensione facoltativa post partum non retrib. quarto figlio 0-12 anni 600 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child4_0_12, DefaultTakable.T_244, DefaultComplation.C_244, null, false,
      true), G_254("254 - Astensione facoltativa post partum 30% quarto figlio 0-6 anni 150 giorni",
          "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
          PeriodType.child4_0_6, DefaultTakable.T_254, DefaultComplation.C_254, DefaultGroup.G_244,
          false, true), G_234(
              "234 - Astensione facoltativa post partum 100% quarto figlio 0-12 anni 30 giorni",
  ...
  G_681("681 - Permesso primo lutto", "", DefaultCategoryType.PERMESSO_PRIMO_LUTTO, 0,
      ...
      false), G_682("682 - Permesso secondo lutto", "", DefaultCategoryType.PERMESSO_SECONDO_LUTTO,
          0, GroupAbsenceTypePattern.programmed, PeriodType.year, DefaultTakable.T_682, null, null,
          false, false), G_683("683 - Permesso terzo lutto", "",
