...
public enum DefaultGroup {
  ...
  G_18_PARENTI_DIPENDENTI("18 - Permesso assistenza parenti/affini disabili L. 104/92 tre giorni mese", 
	      "", 
	      DefaultCategoryType.L_104_PARENTI_DIPENDENTI, 2,
	      GroupAbsenceTypePattern.programmed, PeriodType.month, 
	      DefaultTakable.T_18, DefaultComplation.C_18, null, false, false),
  ...
  MALATTIA_FIGLIO_2("122/132/142 - Malattia secondo figlio", 
      "", 
      DefaultCategoryType.MALATTIA_FIGLIO_2, 1,
      GroupAbsenceTypePattern.simpleGrouping, PeriodType.always, 
      DefaultTakable.T_MALATTIA_FIGLIO_2, null, null, false, false),
  
  MALATTIA_FIGLIO_3("123/133/143 - Malattia terzo figlio", 
      "", 
      DefaultCategoryType.MALATTIA_FIGLIO_3, 2,
      GroupAbsenceTypePattern.simpleGrouping, PeriodType.always, 
      DefaultTakable.T_MALATTIA_FIGLIO_3, null, null, false, false),
  ...
  RIPOSI_CNR_ATTESTATI("Riposi compensativi attestati", 
      "", 
      DefaultCategoryType.CODICI_AUTOMATICI, 0, 
      GroupAbsenceTypePattern.programmed, PeriodType.year, 
      DefaultTakable.T_RIPOSI_CNR_ATTESTATI, null, null, true, false),
