...
public enum DefaultGroup {
  ...
  G_182M("182 Ore e minuti - Permesso assistenza secondo parenti/affini disabili L. 104/92 tre gg. mese in ore e minuti", "",
      DefaultCategoryType.L_104, 1, GroupAbsenceTypePattern.programmed, PeriodType.month,
  ...
  G_183M("183 Ore e minuti - Permesso assistenza terzo parenti/affini disabili L. 104/92 tre gg. mese", "",
      DefaultCategoryType.L_104, 1, GroupAbsenceTypePattern.programmed, PeriodType.month,
  ...
  G_19("19 - Permesso per dipendente disabile L. 104/92 tre giorni mese", "",
      ...
      DefaultTakable.T_19, null, null, false, false), 
  G_19_DIPENDENTI("19 - Permesso per dipendente disabile L. 104/92 tre giorni mese", "",
      ...
      PeriodType.month, DefaultTakable.T_19, null, null, false, false), 
  G_19M("19 Ore e minuti - Permesso per dipendente disabile L. 104/92 tre giorni mese in ore e minuti", "",
      DefaultCategoryType.L_104, 2, GroupAbsenceTypePattern.programmed, PeriodType.month,
      DefaultTakable.T_19M, DefaultComplation.C_19, null, false, false), 
  G_19_DIPENDENTIM("19 Ore e minuti - Permesso per dipendente disabile L. 104/92 tre giorni mese in ore e minuti", "",
      DefaultCategoryType.L_104_DIPENDENTI, 2, GroupAbsenceTypePattern.programmed,
      PeriodType.month, DefaultTakable.T_19M, DefaultComplation.C_19, null, false, false), 
  ...
  G_7R("7R - Permessi RSU dirigenti", "", DefaultCategoryType.ALTRI_CODICI, 0, 
      GroupAbsenceTypePattern.programmed, PeriodType.year, 
      DefaultTakable.T_PERMESSI_RSU_DIRIGENTI, DefaultComplation.C_7R, null, false, true),
...
//      DefaultTakable.T_FERIE_CNR_PROROGA_2023, null, null, false, false),
  ...
  PROROGA_FERIE_2024("31_2024 - Proroga ferie 2024", "", 
      DefaultCategoryType.PROROGA_FERIE_2024, 2, // must be greater than FERIE_CNR
      GroupAbsenceTypePattern.simpleGrouping, PeriodType.always, 
      DefaultTakable.T_FERIE_CNR_PROROGA_2024, null, null, false, false),
  ...
  G_25A("25A - Astensione facoltativa post partum 30% primo figlio 0-14 anni 90 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child1_0_14, DefaultTakable.T_25A, DefaultComplation.C_25A, null,
      false, true),
  G_252A("252A - Astensione facoltativa post partum 30% secondo figlio 0-14 anni 90 giorni", "",
      DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child2_0_14, DefaultTakable.T_252A, DefaultComplation.C_252A, null,
      false, true), 
  G_253A("253A - Astensione facoltativa post partum 30% terzo figlio 0-14 anni 90 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child3_0_14, DefaultTakable.T_253A, DefaultComplation.C_253A, null,
      false, true), 
  G_254A("254A - Astensione facoltativa post partum 30% quarto figlio 0-14 anni 90 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
  ...
  G_24PROV("24 - Retribuzione 80% 1 figlio", "24 - Retribuzione provvisoria 80% 1 figlio",
      DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child1_0_6, DefaultTakable.T_24PROV, DefaultComplation.C_24PROV, null, false,
      false), 
  G_242PROV("242 - Retribuzione 80% 2 figlio", "242 - Retribuzione provvisoria 80% 2 figlio",
      DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child2_0_6, DefaultTakable.T_242PROV, DefaultComplation.C_242PROV, null, false,
      false), 
  ...
  G_24("24 - Retribuzione 80% 1 figlio", "Retribuzione provvisoria 80% 1 figlio",
      DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child1_0_6, DefaultTakable.T_24, DefaultComplation.C_24, null, false,
      true), 
  ...
  G_25O("25 - Astensione facoltativa post partum 30% primo figlio 0-6 anni 150 giorni",
      ...
      PeriodType.child1_0_14, DefaultTakable.T_25O, DefaultComplation.C_25O, DefaultGroup.G_24,
      false, true), 
  G_25("25 - Astensione facoltativa post partum 30% primo figlio 0-14 anni 150 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child1_0_14, DefaultTakable.T_25, DefaultComplation.C_25, DefaultGroup.G_25A,
      false, true), 
  G_25S("25S - Congedo parentale genitore unico 30% 1 figlio 90 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child1_0_14, DefaultTakable.T_25S, DefaultComplation.C_25S, null,
      false, true), 
  ...
  G_23O("23 - Astensione facoltativa post partum 100% primo figlio 0-12 anni 30 giorni",
      ...
      DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child1_0_14, DefaultTakable.T_23, DefaultComplation.C_23,
      DefaultGroup.G_25O, false, true),
  
  G_23("23 - Astensione facoltativa post partum 100% primo figlio 0-14 anni 30 giorni",
  ...
  G_242("242 - Astensione facoltativa post partum non retrib. "
      ...
      "", DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child2_0_6, DefaultTakable.T_242, DefaultComplation.C_242, null, false,
      true), 
  G_252O("252 - Astensione facoltativa post partum 30% secondo figlio 0-6 anni 150 giorni", "",
      DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child2_0_14, DefaultTakable.T_252O, DefaultComplation.C_252O, DefaultGroup.G_242,
      false, true),
  G_252("252 - Astensione facoltativa post partum 30% secondo figlio 0-14 anni 150 giorni", "",
      DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child2_0_14, DefaultTakable.T_252, DefaultComplation.C_252, DefaultGroup.G_252A,
      false, true), 
  
  G_252S("252S - Congedo parentale genitore unico 30% 2 figlio 90 giorni", "",
      DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child2_0_14, DefaultTakable.T_252S, DefaultComplation.C_252S, null,
      false, true), 
  ...
  G_232O("232O - Astensione facoltativa post partum 100% secondo figlio 0-12 anni 30 giorni",
      ...
      DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child2_0_14, DefaultTakable.T_232, DefaultComplation.C_232,
      DefaultGroup.G_252O, false, true),
  G_232("232 - Astensione facoltativa post partum 100% secondo figlio 0-14 anni 30 giorni",
  ...
  G_243("243 - Astensione facoltativa post partum non retrib. terzo figlio 0-12 anni 600 giorni",
      "", DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child3_0_6, DefaultTakable.T_243, DefaultComplation.C_243, null, false, true), 
  G_253O("253 - Astensione facoltativa post partum 30% terzo figlio 0-6 anni 150 giorni",
      "", DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child3_0_14, DefaultTakable.T_253O, DefaultComplation.C_253O, DefaultGroup.G_243,
      false, true),
  G_253("253 - Astensione facoltativa post partum 30% terzo figlio 0-14 anni 150 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child3_0_14, DefaultTakable.T_253, DefaultComplation.C_253, DefaultGroup.G_253A,
      false, true), 
  G_233O("233 - Astensione facoltativa post partum 100% terzo figlio 0-12 anni 30 giorni",
      ...
      DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child3_0_14, DefaultTakable.T_233, DefaultComplation.C_233,
      DefaultGroup.G_253O, false, true),
  
  G_233("233 - Astensione facoltativa post partum 100% terzo figlio 0-14 anni 30 giorni",
  ...
  G_244("244 - Astensione facoltativa post partum non retrib. quarto figlio 0-12 anni 600 giorni",
      "", DefaultCategoryType.ALTRI_CODICI, 0, GroupAbsenceTypePattern.programmed,
      PeriodType.child4_0_6, DefaultTakable.T_244, DefaultComplation.C_244, null, false, true), 
  G_254O("254 - Astensione facoltativa post partum 30% quarto figlio 0-6 anni 150 giorni",
      ...
      false, true), 
  G_254("254 - Astensione facoltativa post partum 30% quarto figlio 0-14 anni 150 giorni",
      "", DefaultCategoryType.ASTENSIONE_POSTPARTUM, 0, GroupAbsenceTypePattern.programmed,
  ...
  G_234("234 - Astensione facoltativa post partum 100% quarto figlio 0-14 anni 30 giorni",
