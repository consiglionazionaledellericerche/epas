...
public enum DefaultComplation {
  ...
  C_244PROV(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_244MPROV), 
      ImmutableSet.of(DefaultAbsenceType.A_244H7PROV)),
  C_245PROV(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_245MPROV), 
      ImmutableSet.of(DefaultAbsenceType.A_245H7PROV)),
  ...
  C_235(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_235M), 
      ImmutableSet.of(DefaultAbsenceType.A_235H7)),
  ...
  C_255(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_255M), 
      ImmutableSet.of(DefaultAbsenceType.A_255H7)),
  C_255A(AmountType.units, 
      ImmutableSet.of(DefaultAbsenceType.A_255AM), 
      ImmutableSet.of(DefaultAbsenceType.A_255AH7)),
