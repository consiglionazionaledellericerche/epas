...
public enum DefaultAbsenceType {
  ...
  A_18H2("18H2", "Permesso assistenza parenti/affini disabili L. 104/92 completamento 2 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      120, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), null, null),
  A_18H3("18H3", "Permesso assistenza parenti/affini disabili L. 104/92 completamento 3 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      180, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), null, null),
  A_18H4("18H4", "Permesso assistenza parenti/affini disabili L. 104/92 completamento 4 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      240, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), null, null),
  ...
  A_92("92", "Missione",
      ...
      0, null, Sets.newHashSet(new Behaviour(JustifiedBehaviourName.maximumTime, 1000)), null, null),
  ...
  A_92H1("92H1", "Missione 1 ora",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      60, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), new LocalDate(2019,2,15), null),
  A_92H2("92H2", "Missione 2 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      120, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), new LocalDate(2019,2,15), null),
  A_92H3("92H3", "Missione 3 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      180, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), new LocalDate(2019,2,15), null),
  A_92H4("92H4", "Missione 4 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      240, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), new LocalDate(2019,2,15), null),
  A_92H5("92H5", "Missione 5 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      300, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), new LocalDate(2019,2,15), null),
  A_92H6("92H6", "Missione 6 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      360, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), new LocalDate(2019,2,15), null),
  A_92H7("92H7", "Missione 7 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      420, JustifiedTypeName.absence_type_minutes, Sets.newHashSet(), new LocalDate(2019,2,15), null),
  
  
  A_92HO1("92H1", "Missione 1 ora",
      false, ImmutableSet.of(JustifiedTypeName.absence_type_minutes), 60, false, true,
      0, null, Sets.newHashSet(), new LocalDate(2011,1,1), new LocalDate(2019,2,14)),
  ...
  A_142("142", "malattia secondo figlio non retribuita",
      false, ImmutableSet.of(JustifiedTypeName.all_day), 0, true, false,
      0, null, Sets.newHashSet(), new LocalDate(1990, 1, 1), new LocalDate(2008, 12, 31)),
