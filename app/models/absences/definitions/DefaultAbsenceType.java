...
public enum DefaultAbsenceType {
  ...
  A_COVID19("COVID19", "Emergenza coronavirus, attività lavorativa presso il domicilio dei dipendenti",
  ...
  A_20("20", "Congedo/permesso DPR 1026 Art. 20",
      false, ImmutableSet.of(JustifiedTypeName.all_day), 0, true, false,
      0, null, Sets.newHashSet(), null, new LocalDate(2019,12,31),false),
  
  A_20M("20M", "Congedo/permesso DPR 1026 Art. 20 in ore e minuti",
      true, ImmutableSet.of(JustifiedTypeName.specified_minutes), 0, false, true,
      0, null, Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
  A_20H1("20H1", "Congedo/permesso DPR 1026 Art. 20 1 ora",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      60, JustifiedTypeName.absence_type_minutes, 
      Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
  A_20H2("20H2", "Congedo/permesso DPR 1026 Art. 20 2 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      120, JustifiedTypeName.absence_type_minutes, 
      Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
  A_20H3("20H3", "Congedo/permesso DPR 1026 Art. 20 3 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      180, JustifiedTypeName.absence_type_minutes, 
      Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
  A_20H4("20H4", "Congedo/permesso DPR 1026 Art. 20 4 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      240, JustifiedTypeName.absence_type_minutes, 
      Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
  A_20H5("20H5", "Congedo/permesso DPR 1026 Art. 20 5 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      300, JustifiedTypeName.absence_type_minutes, 
      Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
  A_20H6("20H6", "Congedo/permesso DPR 1026 Art. 20 6 ore",
    false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      360, JustifiedTypeName.absence_type_minutes, 
      Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
  A_20H7("20H7", "Congedo/permesso DPR 1026 Art. 20 7 ore",
      false, ImmutableSet.of(JustifiedTypeName.nothing), 0, false, false,
      420, JustifiedTypeName.absence_type_minutes, 
      Sets.newHashSet(), new LocalDate(2020,1,1), null, false),
