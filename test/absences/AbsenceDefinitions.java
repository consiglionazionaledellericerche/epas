...
public class AbsenceDefinitions {
  ...
  public static Set<JustifiedTypeName> PERMITTED_NOTHING = ImmutableSet.of(JustifiedTypeName.nothing);
  public static Set<JustifiedTypeName> PERMITTED_SPECIFIED_MINUTES = ImmutableSet.of(JustifiedTypeName.specified_minutes);
  ...
  public enum AbsenceTypeDefinition {
    ...
    _661M(0, false, false, PERMITTED_SPECIFIED_MINUTES, null, JustifiedTypeName.absence_type_minutes);
  ...
  public enum GroupAbsenceTypeDefinition {
    ...
    private GroupAbsenceTypeDefinition(GroupAbsenceTypePattern pattern, 
        ...
        ComplationBehaviourDefinition complationAbsenceBehaviour, GroupAbsenceType next) {
