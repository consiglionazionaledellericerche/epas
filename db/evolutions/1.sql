...
ALTER TABLE public.seq_contact_data OWNER TO epas;
...
ALTER TABLE public.seq_locations OWNER TO epas;
...
ALTER TABLE public.seq_person_months OWNER TO epas;
...
CREATE TABLE absence_type_groups (
    id bigint NOT NULL DEFAULT nextval('seq_absence_type_groups'),
...
CREATE TABLE absence_types (
    id bigint NOT NULL DEFAULT nextval('seq_absence_types'),
...
CREATE TABLE absences (
    id bigint NOT NULL DEFAULT nextval('seq_absences'),
...
CREATE TABLE auth_users (
    id bigint NOT NULL DEFAULT nextval('seq_auth_users'),
...
CREATE TABLE badge_readers (
    id bigint NOT NULL DEFAULT nextval('seq_badge_readers'),
    code character varying(255),
    description character varying(255),
...
CREATE TABLE competence_codes (
    id bigint NOT NULL DEFAULT nextval('seq_competence_codes'),
    code character varying(255),
...
CREATE TABLE competences (
    id bigint NOT NULL DEFAULT nextval('seq_competences'),
...
CREATE TABLE configurations (
    id bigint NOT NULL DEFAULT nextval('seq_configurations'),
...
CREATE TABLE contact_data (
    id bigint NOT NULL DEFAULT nextval('seq_contact_data'),
...
ALTER TABLE public.contact_data OWNER TO epas;
...
ALTER TABLE public.contact_data_history OWNER TO epas;



CREATE TABLE contracts (
    id bigint NOT NULL DEFAULT nextval('seq_contracts'),
    begin_contract date,
    end_contract date,
...
CREATE TABLE groups (
    id bigint NOT NULL DEFAULT nextval('seq_groups'),
    description character varying(255)
);
...
CREATE TABLE initialization_absences (
    id bigint NOT NULL DEFAULT nextval('seq_initialization_absences'),
    absencedays integer,
    date date,
...
CREATE TABLE initialization_times (
    id bigint NOT NULL DEFAULT nextval('seq_initialization_times'),
    date date,
...
CREATE TABLE locations (
    id bigint NOT NULL DEFAULT nextval('seq_locations'),
...
ALTER TABLE public.locations OWNER TO epas;



CREATE TABLE options (
    id bigint NOT NULL DEFAULT nextval('seq_options'),
...
CREATE TABLE permissions (
    id bigint NOT NULL DEFAULT nextval('seq_permissions'),
    description character varying(255)
);
...
CREATE TABLE person_children (
    id bigint NOT NULL DEFAULT nextval('seq_person_children'),
    borndate bytea,
...
CREATE TABLE person_days (
    id bigint NOT NULL DEFAULT nextval('seq_person_days'),
    date date,
    difference integer,
...
CREATE TABLE person_hour_for_overtime (
    id bigint NOT NULL DEFAULT nextval('seq_person_hour_for_overtime'),
...
CREATE TABLE person_months (
    id bigint NOT NULL DEFAULT nextval('seq_person_months'),
...
ALTER TABLE public.person_months OWNER TO epas;
...
ALTER TABLE public.person_months_history OWNER TO epas;



CREATE TABLE person_reperibility (
    id bigint NOT NULL DEFAULT nextval('seq_person_reperibility'),
    end_date date,
...
CREATE TABLE person_reperibility_days (
    id bigint NOT NULL DEFAULT nextval('seq_person_reperibility_days'),
    date date,
    holiday_day boolean,
...
CREATE TABLE person_reperibility_types (
    id bigint NOT NULL DEFAULT nextval('seq_person_reperibility_types'),
    description character varying(255)
);
...
CREATE TABLE person_shift (
    id bigint NOT NULL DEFAULT nextval('seq_person_shift'),
    description character varying(255),
...
CREATE TABLE person_shift_days (
    id bigint NOT NULL DEFAULT nextval('seq_person_shift_days'),
    date date,
...
CREATE TABLE person_shift_shift_type (
    id bigint NOT NULL DEFAULT nextval('seq_person_shift_shift_type'),
    begin_date date,
    end_date date,
...
CREATE TABLE person_years (
    id bigint NOT NULL DEFAULT nextval('seq_person_years'),
...
CREATE TABLE persons (
    id bigint NOT NULL DEFAULT nextval('seq_persons'),
...
ALTER TABLE public.persons_permissions OWNER TO epas;
...
ALTER TABLE public.persons_permissions_history OWNER TO epas;



CREATE TABLE qualifications (
    id bigint NOT NULL DEFAULT nextval('seq_qualifications'),
    description character varying(255),
...
CREATE TABLE shift_cancelled (
    id bigint NOT NULL DEFAULT nextval('seq_shift_cancelled'),
    date date,
...
CREATE TABLE shift_time_table (
    id bigint NOT NULL DEFAULT nextval('seq_shift_time_table'),
    description character varying(255),
...
CREATE TABLE shift_type (
    id bigint NOT NULL DEFAULT nextval('seq_shift_type'),
    description character varying(255),
...
CREATE TABLE stamp_modification_types (
    id bigint NOT NULL DEFAULT nextval('seq_stamp_modification_types'),
    code character varying(255),
    description character varying(255)
);
...
CREATE TABLE stamp_profiles (
    id bigint NOT NULL DEFAULT nextval('seq_stamp_profiles'),
    end_to date,
...
CREATE TABLE stamp_types (
    id bigint NOT NULL DEFAULT nextval('seq_stamp_types'),
    code character varying(255),
    description character varying(255),
...
CREATE TABLE stampings (
    id bigint NOT NULL DEFAULT nextval('seq_stampings'),
    date timestamp without time zone,
...
CREATE TABLE total_overtime (
    id bigint NOT NULL DEFAULT nextval('seq_total_overtime'),
    date date,
...
CREATE TABLE vacation_codes (
    id bigint NOT NULL DEFAULT nextval('seq_vacation_codes'),
    description character varying(255),
...
CREATE TABLE vacation_periods (
    id bigint NOT NULL DEFAULT nextval('seq_vacation_periods'),
    begin_from date,
    end_to date,
    person_id bigint NOT NULL,
...
CREATE TABLE valuable_competences (
    id bigint NOT NULL DEFAULT nextval('seq_valuable_competences'),
...
CREATE TABLE web_stamping_address (
    id bigint NOT NULL DEFAULT nextval('seq_web_stamping_address'),
...
CREATE TABLE working_time_type_days (
    id bigint NOT NULL DEFAULT nextval('seq_working_time_type_days'),
...
CREATE TABLE working_time_types (
    id bigint NOT NULL DEFAULT nextval('seq_working_time_types'),
...
CREATE TABLE year_recaps (
    id bigint NOT NULL DEFAULT nextval('seq_year_recaps'),
...
ALTER TABLE ONLY vacation_periods
    ADD CONSTRAINT vacation_periods_person_id_key UNIQUE (person_id);
...
ALTER TABLE ONLY vacation_periods
    ADD CONSTRAINT fk5170df70e7a7b1be FOREIGN KEY (person_id) REFERENCES persons(id);
