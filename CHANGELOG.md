...
### Added
  ...
  - Aggiunto parametro generale per decidere se impostare la disabilitazione del calcolo del residuo per i part time
    orizzontali in modo che siano le istallazioni a decidere come comportarsi
  - Aggiunto codice LAGILEBP che consente la maturazione del buono pasto e gestito a livello di istallazione

## [2.32.2] - 2026-06-19
### Changed
  - Modificato il periodo di fruizione per i vecchi gruppi 23O, 232O ecc... fino a 14 anni per evitare il rosso
    nel cartellino del dipendente che prende i 23, 232
...
### Changed
  - Risolto il caso in cui un responsabile di gruppo sia un tecnico/amministrativo e non può approvare le richieste
    di lavoro straordinario da parte dei dipendenti del suo gruppo.
...
## [2.29.1] - 2025-12-12
### Added
  - Aggiunto flusso per la richiesta dei giorni di 31_2024.
